...
function LibraryFrame({ activeSlug, children }: { activeSlug?: string; children: ReactNode }) {
  return (
    <div className="min-h-screen bg-[#0d0f0c] text-[#f1f2ec]">
      <header className="fixed inset-x-0 top-0 z-40 flex h-14 items-center border-b border-white/[0.08] bg-[#0a0c09]/95 px-5 backdrop-blur-xl">
        <a className="flex items-center gap-2.5 rounded-lg" href="/">
          <span className="grid size-8 place-items-center rounded-lg bg-[#dfff57] font-mono text-[10px] font-black text-[#171914]">
            MR
          </span>
          <strong className="text-sm font-[680] tracking-[-0.02em]">Media Rig</strong>
        </a>
        <nav className="ml-8 flex items-center gap-5 text-xs text-white/50 max-[720px]:hidden" aria-label="主导航">
          <a className="transition hover:text-white" href="/">Home</a>
          <a className="transition hover:text-white" href="/#components">Components</a>
          <a className="transition hover:text-white" href="/r/registry.json">Registry</a>
        </nav>
        <a
          className="ml-auto flex h-8 w-[min(260px,36vw)] items-center gap-2 rounded-lg border border-white/[0.08] bg-white/[0.04] px-3 text-[11px] text-white/35 transition hover:border-white/15 hover:text-white/60"
          href="/#components"
        >
          <Search size={13} aria-hidden="true" />
          <span className="truncate">Browse components…</span>
          <kbd className="ml-auto font-mono text-[9px] text-white/20">/</kbd>
        </a>
      </header>

      <div className="grid min-h-screen grid-cols-[236px_minmax(0,1fr)] pt-14 max-[900px]:grid-cols-1">
        <aside className="sticky top-14 z-20 flex h-[calc(100vh-3.5rem)] flex-col border-r border-white/[0.07] bg-[#080a08] px-4 py-5 text-white max-[900px]:static max-[900px]:h-auto max-[900px]:border-r-0 max-[900px]:border-b">
          <div className="flex items-center gap-3 rounded-xl px-2 py-1.5">
            ...
            <span>
              <strong className="block text-[13px] font-[680] tracking-[-0.02em]">Components</strong>
              <small className="block text-[10px] uppercase tracking-[0.16em] text-white/35">Media primitives</small>
            </span>
          </div>

          <nav className="mt-6 flex-1 max-[900px]:mt-4" aria-label="组件导航">
  ...
  return (
    <LibraryFrame>
      <main>
        ...
        <section id="components" className="scroll-mt-20 px-12 py-10 max-[760px]:px-5 max-[760px]:py-7">
...
function ComponentDetail({ component }: { component: MediaComponentMeta }) {
  ...
  return (
    <LibraryFrame activeSlug={component.slug}>
      <main className="px-8 pb-20 pt-8 max-[760px]:px-4 max-[760px]:pt-6">
        <div className="mx-auto grid max-w-[1480px] grid-cols-[minmax(0,1fr)_180px] gap-12 max-[1240px]:grid-cols-1">
          <div className="min-w-0">
            ...
            <section id="installation" className={["mx-auto mt-14 scroll-mt-20", component.previewClassName].join(" ")}>
              <div className="mb-4">
                <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#dfff57]/60">Installation</p>
          ...
          <aside className="sticky top-20 h-fit text-xs max-[1240px]:hidden" aria-label="页面目录">
            <p className="mb-3 font-semibold uppercase tracking-[0.12em] text-white/30">On this page</p>
