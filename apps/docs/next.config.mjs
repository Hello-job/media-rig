...
const slugs = "light-sphere|image-angle-rig|director-stage|image-editor|image-annotation|layer-separator";
export default {
  ...
  async redirects() {
    return [
      ...
      ...Object.entries({ light: "light-sphere", angle: "image-angle-rig", editor: "image-editor", annotation: "image-annotation", layers: "layer-separator" }).map(([demo, slug]) => ({ source: "/", has: [{ type: "query", key: "demo", value: demo }], destination: `/components/${slug}`, permanent: true })),
