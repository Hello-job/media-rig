...
export default function LightSpherePreview() {
  ...
  const viewButtonClass = (mode: LightSphereViewMode) =>
    [
      "cursor-pointer rounded-2xl border-0 bg-transparent text-[26px] font-bold leading-none tracking-normal",
  ...
  return (
    <div className="grid h-full min-h-0 w-full grid-cols-[1fr_380px] bg-[#141414] max-[720px]:grid-cols-1 max-[720px]:grid-rows-[1fr_auto]">
      ...
      <aside className="flex flex-col overflow-y-auto border-l border-white/[0.06] bg-[#1d1d1d] px-7 pb-7 pt-3 max-[720px]:max-h-[40vh] max-[720px]:border-l-0 max-[720px]:border-t max-[720px]:border-white/[0.06]">
        <LightSphereControls
          config={config}
